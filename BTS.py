...
def go_next():
    ...
    #print(files)
    #print(paths[0])
    tosend=paths[files.index('BSI_100_2_Windows_v1.0.audit')] #BSI_100_2_Windows_v1.0.audit
    #structure=os.system("python view_audit_structure.py "+paths[tosend])
    structure=view_audit_structure.main(tosend)
    print('Am primit din main:')
    print(structure)
